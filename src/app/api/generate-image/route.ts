...
export async function POST(request: NextRequest) {
  try {
    ...
    // Use user's API key if they have one, otherwise fall back to env variable
    const replicateApiKey = userDoc.data()?.replicateApiKey || process.env.REPLICATE_API_TOKEN;
